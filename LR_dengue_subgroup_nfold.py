...
img_filename = f'logistic_regression_dengue_subgroup_analysis_{splits}_fold_ROC' + tag
...
# save file
plt.savefig(save_path/f'{img_filename}.png', bbox_inches='tight')
plt.show()
print('roc made')
...
#         # analysis[1][0] returns 0.90, analysis[1][1] returns results for recall=0.90, and so forth
    ...
    to_file = f'logistic_regression_dengue_subgroup_analysis_{splits}_fold_recall_{rec:0.2f}' + tag

    final_subgroup_results.to_csv(save_path/f'{to_file}.csv', index=None)
